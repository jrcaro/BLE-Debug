...
/**
 * A subclass of java.org.util.Random that implements the Xorshift random number
 * generator
 *
 * - it is 30% faster than the generator from Java's library - it produces
 * random sequences of higher quality than java.org.util.Random - this class also
 ...
 * and assign it to a java.org.util.Random object: java.org.util.Random rand = new
 * XSRandom();
 *
...
public class XSRandom extends Random{
     ...
     * 30% faster and better quality than the built-in java.org.util.Random see also
